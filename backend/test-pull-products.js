...
async function testPushProducts() {
  try {
    ...
    if (loginResponse.data.success) {
      ...
      console.log('\n🧪 Testing /setup/products (pull - Prokip to WooCommerce)...');
      try {
        ...
        console.log('✅ Pull products successful!');
        console.log('📊 Response:', JSON.stringify(pushResponse.data, null, 2));
      } catch (pushError) {
        console.error('❌ Pull products failed:', pushError.response?.data || pushError.message);
      }
