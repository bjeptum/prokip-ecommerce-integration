    ...
    try {
      ...
      for (const order of orders) {
        ...
        try {
          ...
          // WORKAROUND: Due to Prokip API bug with variation_id, use stock adjustment approach
          console.log(`📝 Using stock adjustment workaround for order ${order.id} with ${validSellProducts.length} products`);
