...
async function updateCorrectWooCommerceCredentials() {
  console.log('🔧 Updating Correct WooCommerce Credentials');
  console.log('=========================================');
  ...
  try {
    ...
    // Your actual store and credentials
    const actualStoreUrl = 'https://learn.prokip.africa';
    const actualConsumerKey = 'ck_9dd6b146b7abfd64660215805e0913446cd41597';
    const actualConsumerSecret = 'cs_d8e1b8c2cd2c5e5aee3f943971f9e379449baa1e';
    
    console.log(`   Store URL: ${actualStoreUrl}`);
    ...
    try {
      ...
      console.log('\n📋 FINAL STATUS:');
      console.log('✅ Store URL updated to: https://learn.prokip.africa');
      ...
      if (error.response?.status === 401) {
        ...
        console.log('1. Consumer Key: ck_9dd6b146b7abfd64660215805e0913446cd41597');
        console.log('2. Consumer Secret: cs_d8e1b8c2cd2c5e5aee3f943971f9e379449baa1e');
        console.log('3. Permissions: Read/Write');
        console.log('4. Store URL: https://learn.prokip.africa');
      }
    }
...
// Run update
updateCorrectWooCommerceCredentials();
